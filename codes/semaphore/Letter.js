class Letter {
     ...
     */
    constructor(letter, reanchor, startPoint) {
        ...
        let point2 = new Point(point1.x + stroke1[0], point2.y + stroke1[1]);
     ...
     */
    flip() {
        let temp = this.stroke1.start;
        this.stroke1.start = this.stroke2.end;
        this.stroke2.end = temp;
    }


    reanchor() {
        this = new Letter(this.letter, true);
        return this;
    }
...
function checkLetterIntersection(letter1, letter2) {
 ...
 */
function checkStrokeIntersection(stroke1, stroke2) {
